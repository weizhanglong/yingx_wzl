...
public class FeedbackServiceImpl implements FeedbackService{
    ...
    public HashMap<String, Object> queryByPage(Integer page, Integer rows) {
        ...
        //总条数
        int records = fm.selectCountByExample(example);
        ...
        List<Feedback> logs = fm.selectByExampleAndRowBounds(example,rowBounds);
        map.put("rows",logs);
    ...
    public void Exports() {
        ...
        //查询数据数据
        List<Feedback> feedbacks = fm.selectAll();
